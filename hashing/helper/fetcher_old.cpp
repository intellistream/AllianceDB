...
__always_inline
fetch_t *
next_tuple_S_first(t_state *state, std::chrono::milliseconds *fetchStartTime, relation_t *relS) {
    tuple_t *readR = nullptr;
    tuple_t *readS = nullptr;
    milliseconds min_gap = (milliseconds) INT32_MAX;
...
__always_inline
fetch_t *
next_tuple_R_first(t_state *state, std::chrono::milliseconds *fetchStartTime, relation_t *relR) {
    tuple_t *readR = nullptr;
    tuple_t *readS = nullptr;
    milliseconds min_gap = (milliseconds) INT32_MAX;
    std::chrono::milliseconds arrivalTsR;
