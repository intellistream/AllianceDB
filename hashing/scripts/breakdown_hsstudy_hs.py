...
COLOR_MAP = ('#000000', '#88CCEE', '#FFFFFF', '#117733', '#999933', '#DDCC77', '#CC6677', '#882255', '#AA4499')
...
def ReadFile(id):
    ...
    for i in range(id, bound, 1):
        cnt = 0
        print(i)
        f = open("/data1/xtra/results/breakdown/SHJ_HS_NP_{}.txt".format(i), "r")
        read = f.readlines()
        others = 0
        for x in read:
...
if __name__ == "__main__":
    ...
    x_values = [500, 750, 1000, 1250, 1500]  # window size
