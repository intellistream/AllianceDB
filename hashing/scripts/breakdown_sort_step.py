...
if __name__ == "__main__":
    ...
    x_values = [64, 256, 1024, 2056]  # number of radix bits.

    y_values, max_value = ReadFile(id)  # 75: stock, 76: Rovio, 77: YSB, 78: DEBS.
    ...
    DrawFigure(x_values, y_values, double(ceil(max_value / 1000.0)) * 1000, legend_labels, '',
               '',
               'breakdown_sort_step_figure{}'.format(id), id, False)

    DrawLegend(legend_labels, 'breakdown_sort_step_legend')
