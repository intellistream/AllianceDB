...
result_t *
SHJ_JM_P(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
PMJ_st(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
PMJ_JM_NP(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
PMJ_JB_NP(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
PMJ_JBCR_NP(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
PMJ_HS_NP(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
 ...
 */
result_t *
RPJ_st(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
...
result_t *
RPJ_HS_NP(relation_t *relR, relation_t *relS, int nthreads, int exp_id, int group_size);
