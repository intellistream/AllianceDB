...
DEFAULT_STEP_SIZE=100   # |tuples| per ms.
...
for algo in m-way m-pass; do #
  ...
  RTS=0
  STS=0
  for benchmark in "AR" "AD" "KD" "WS" "KD2" "WS2" "RAR" "RAR2" "WS3" "WS4"; do #"Stock"  "Rovio" "YSB"  "DEBS" #"ScaleStock" "ScaleRovio" "ScaleYSB" "ScaleDEBS" "AD" "KD" "WS" "KD2" "WS2" "RAR" "RAR2" "WS3" "WS4" "Stock" "Rovio" "YSB" "DEBS"
    case "$benchmark" in
