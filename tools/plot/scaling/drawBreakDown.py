...
def main():
    ...
    accuBar.DrawFigure(['LL', 'LB', 'BL', 'BB'], ([r1, r2]), ['load+remap', 'write'], '', 'latency/us',
                       'lz4_pipe2_2stage_breakdown', True, '')
    groupBar2.DrawFigure(['LL', 'LB', 'BL', 'BB'], ([r1, r2]), ['load+remap', 'write'], 0, 0, 'algos', 'latency/us',
                         'lz4_pipe2_2stage_bottleneck', 1)
    ru, idx = maxInList([r1, r2])
    accuBar.DrawFigure(['LL', 'LB', 'BL', 'BB'], ([ru]), ['bottleneck'], '', 'latency/us', 'lz4_pipe2_2stage_botonly',
                       True, '')
